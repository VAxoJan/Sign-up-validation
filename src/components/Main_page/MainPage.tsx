  ...
  return (
    <div className="flex justify-center items-center w-screen h-screen">
      <div className="flex flex-col md:flex-row w-full max-w-[1200px] h-auto md:h-[600px] justify-between">
        <div className="flex flex-col justify-center px-[20px] xl:px-0 items-center w-full md:w-[500px] my-8 md:my-0 md:ml-[50px] font-mainFont">
          <h1 className="text-white font-bold text-[50px] md:text-[60px] leading-[50px] md:leading-[60px] text-center">
        ...
        <div className="flex flex-col justify-center items-center md:items-start w-full md:w-[540px]">
          <div className="flex w-full xl:w-[540px] justify-center flex-col md:flex-row  bg-[#5E54A4] font-mainFont text-white gap-2 py-4">
            <h1 className="font-bold text-center md:text-left">
              Try it free for 7 days
            </h1>
            <p className="font-med text-center md:text-left">
